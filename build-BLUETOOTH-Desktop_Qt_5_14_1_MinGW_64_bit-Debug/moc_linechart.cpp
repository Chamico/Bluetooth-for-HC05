...
#include <memory>
#include "../BLUETOOTH/LineChart/linechart.h"
...
QT_MOC_LITERAL(1, 10, 16), // "LineChartGetData"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "LineChart\0LineChartGetData\0"
};
...
void LineChart::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->LineChartGetData((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
