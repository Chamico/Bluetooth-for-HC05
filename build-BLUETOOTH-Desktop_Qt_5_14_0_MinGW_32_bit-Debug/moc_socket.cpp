...
#include <memory>
#include "../BLUETOOTH/Socket/socket.h"
...
QT_MOC_LITERAL(1, 7, 19), // "socket_system_error"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 20), // "socket_system_output"
QT_MOC_LITERAL(4, 49, 13), // "socket_thread"
QT_MOC_LITERAL(5, 63, 12) // "TimerProcess"

    },
    "Socket\0socket_system_error\0\0"
    "socket_system_output\0socket_thread\0"
    "TimerProcess"
};
...
void Socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->socket_system_error((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->socket_system_output((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->socket_thread(); break;
        case 3: _t->TimerProcess(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Socket::socket_system_error)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Socket::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Socket::socket_system_output)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Socket::socket_thread)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Socket::socket_system_error(QString _t1)
{
...
// SIGNAL 1
void Socket::socket_system_output(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
