...
#include <memory>
#include "../BLUETOOTH/Bluetooth/bluetooth.h"
...
QT_MOC_LITERAL(1, 10, 22), // "bluetooth_system_error"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "Bluetooth\0bluetooth_system_error\0"
};
...
void Bluetooth::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->bluetooth_system_error((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Bluetooth::bluetooth_system_error)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Bluetooth::bluetooth_system_error(QString _t1)
{
