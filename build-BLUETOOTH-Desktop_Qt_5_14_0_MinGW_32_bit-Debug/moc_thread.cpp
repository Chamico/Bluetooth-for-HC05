...
#include <memory>
#include "../BLUETOOTH/Thread/thread.h"
...
QT_MOC_LITERAL(1, 7, 13), // "thread_output"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "Thread\0thread_output\0"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->thread_output((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::thread_output)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Thread::thread_output(QString _t1)
{
